acidcoin version 0.3.1.0 is now available from:
...
- `6a3e798` acidcoin-Qt (Windows only): enable DEP for acidcoin-qt.exe
...
Miscellaneous:
- `fb66d3f` remove pre-acidcoin protocol versions

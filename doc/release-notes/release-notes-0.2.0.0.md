acidcoin version 0.2.0.0 is now available from:
...
acidcoin data directory (listed below) and delete everything except the
wallet.dat and acidcoin.conf

Linux : ~/.acidcoin/

Windows : %appdata%\Roaming\acidcoin
...
- `62a3da1` Update GitHub URLs to point to acidcoinFoundation/acidcoin
...
- `19ca0ef` Point GitHub URL to acidcoinFoundation
